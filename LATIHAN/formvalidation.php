...
<head>
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" integrity="sha384-MC¥98/SFnGE8f)T3GXMEOngsV72t27NXFoaoApmYm81iuXoPkFOJW]BERdknLPMO" crossorigin="anonymous">
    <style>
        .warning {
            color: #FF0000;
        }
                ...
                <div class="card-body">
                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="pesan" class="form-control <?php echo ($error_pesan != "" ? "is-invalid" : ""); ?>" id="pesan"><?php echo $pesan; ?></textarea>
